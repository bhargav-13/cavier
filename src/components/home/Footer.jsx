                    ...
                    {column.links.map((link, i) => (
                      <li key={i}>
                        <NavLink
                          to={link.path}
                          className={({ isActive }) =>
                            `relative transition-all duration-300 drop-shadow-[0_3px_0_rgba(0,0,0,0.2)] ${
                              isActive
                                ? "text-black font-semibold"
                                : "hover:opacity-60"
                            } after:absolute after:left-0 after:-bottom-1 after:h-[1px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full`
                          }
                        >
                          {link.name}
                        </NavLink>
